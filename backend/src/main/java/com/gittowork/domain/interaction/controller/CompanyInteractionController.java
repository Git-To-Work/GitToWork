...
public class CompanyInteractionController {
    ...
    public ApiResponse<?> addScrapCompany(InteractionPostRequest interactionPostRequest) {
    ...
    public ApiResponse<?> deleteScrapCompany(InteractionPostRequest interactionPostRequest) {
    ...
    public ApiResponse<?> addLikeCompany(InteractionPostRequest interactionPostRequest) {
    ...
    public ApiResponse<?> deleteLikeCompany(InteractionPostRequest interactionPostRequest) {
    ...
    public ApiResponse<?> addMyBlackList(InteractionPostRequest interactionPostRequest) {
    ...
    public ApiResponse<?> deleteMyBlackList(InteractionPostRequest interactionPostRequest) {
