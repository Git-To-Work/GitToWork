...
public class QuizController {
    ...
    public ApiResponse<?> getDeveloperQuiz(@Parameter(description = "퀴즈 형식 (cover-letter:CL, computer-science:CS, fit-interview:FI, skill-stack:SS)", example = "CS") @RequestParam String category) {
